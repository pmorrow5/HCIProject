$(function () {
  ...
  $("#btnAddSemesterPlan").on("click", function () {
    ...
    if (row1.children.length < 4) {
      ...
      fragment.innerHTML = '<div Class="col-lg-3 col-md-3 col-sm-3"><div Class="panel panel-default" style="height:275px"><div id="btnAddCourseR1' + nButtonNumber + '" Class="btn btn-primary" style="margin-left:12px; margin-top:10px; width:90%;">Add Course</div></div></div></div>';
      ...
      $("#btnAddCourseR1" + nButtonNumber).on("click", function (e) {
        ...
        if (addCourseButton.parentNode.children.length < 6) {

          addCourseButton.parentNode.appendChild(fragment);
        }
      });
      ...
      if (row2.children.length < 4) {
        ...
        fragment.innerHTML = '<div Class="col-lg-3 col-md-3 col-sm-3"><div Class="panel panel-default" style="height:275px"><div id="btnAddCourseR2' + nButtonNumber + '" Class="btn btn-primary" style="margin-left:12px; margin-top:10px; width:90%;">Add Course</div></div></div></div>';
